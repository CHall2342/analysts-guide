...
- Adjacent colours need a 3 to 1 contrast ratio to pass accessibility legislation.
...
- People with colour blindness find it hard to identify certain colours, or to tell some colours apart.
...
- When producing content that may be printed, consider how your colours work in black and white.
...
Cognitive load:
- Cognitive load refers to the amount of working memory someone uses when they take in new information and transform it into their long-term memory. When a concept is more complex, the audience is less familiar with the given topic, and/or the explanation is presented in more detail, the cognitive load is higher.
